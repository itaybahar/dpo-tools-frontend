        ...
        <div className="homepage">
            <div className="hero-section">
                ...
                <div className="hero-buttons">
                    <Link to="/dpo-assessment" className="cta-button primary">
                        🧪 Take DPO Assessment
                    </Link>
                    <Link to="/compliance-assessment" className="cta-button secondary">
            ...
            <div className="services-section">
                <div className="service-card dpo-assessment-highlight">
                    <div className="highlight-header">
                        <h3>🚀 Quick Start: DPO Assessment</h3>
                        <span className="highlight-badge">New</span>
                    </div>
                    <p>Not sure if your organization needs a Data Protection Officer? Take our quick 3-question assessment to find out in minutes!</p>
                    <div className="highlight-features">
                        <span className="feature">⚡ 3 Questions</span>
                        <span className="feature">📱 Mobile Friendly</span>
                        <span className="feature">🎯 Instant Results</span>
                        <span className="feature">🔒 GDPR Compliant</span>
                    </div>
                    <Link to="/dpo-assessment" className="highlight-button">
